module.exports = {
    CONFIG: {
        ...
        trtcConfig: {
            ...
            secretKey: "xxxx",          // [Required] Replace with your actual SecretKey
        ...
        STTConfig: {
            Language: "8k_zh",  // 8k ASR model with noise reduction
            VadSilenceTime: 500,  // VAD config for delay and interruption balance
        ...
        LLMConfig: {
            ...
            APIUrl: "http:/api.xxxx.com/v1/chat/completions", // [Required] Your LLM API Url
            APIKey: "xxxx",   // [Required] Replace with your actual LLM APIKey
            History: 10,      // Number of LLM context entries
        ...
        TTSConfig: {
            ...
            GroupId: "18100000000000",
            APIKey: "xxxxxxxxxxxxx",   // [Required] Replace with your actual LLM APIKey
            VoiceType: "your_clone_voice_name",  // Use real customer service voice clone
